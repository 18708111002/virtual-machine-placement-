...
public class SCFFD {
	...
	public int [] SCFFD()
	{
		...
		{	
			...
			{
				int pm = this.pmList.get(j).id;
				
				if(	this.isResouceSatisfy(i,pm,useCPU,useMEM) &&
						this.isNetworkSatisfy(i,pm,ffPlacement)	)
					{
						ffPlacement[i] = pm;
