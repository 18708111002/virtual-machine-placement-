...
public class PsoYsEVMP {
	...
	private final static double SERVER_FULL_ENERGY = 550;//252;
	...
	public PsoYsEVMP(int vm,int pm,int p)
	{
		this.numVM = vm;
		this.numPM = pm;
		this.numParticle = p;
...
//			System.out.println("aggre link core overload:" + (pod.eLinkA[aggre][core] + traffic) );
	...
	private double totalPmEnergy(int [] placement)
	{
