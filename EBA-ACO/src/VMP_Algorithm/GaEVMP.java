...
public class GaEVMP {
	...
	public GaEVMP(int numVm, int numPm) throws IOException
	{
		this.numPM = numPm;
		this.numVM = numVm;
...
//		this.generateVmRequire();
//		this.generateVmTraffic();
//		this.generatePmCapacity();
